...
from pipelinesrc.entity.artifact_entity  import DataIngestionArtifact
from pipelinesrc.entity.config_entity  import DataIngestionConfig
...
class DataIngestion:
    ...
    def export_data_into_feature_store(self) ->DataFrame:
        ...
        try:
            ...
            mydata=Proj1Data()
            dataframe=mydata.export_collection_as_datafrome(collection_name=self.data_ingestion_config.collection_name)
