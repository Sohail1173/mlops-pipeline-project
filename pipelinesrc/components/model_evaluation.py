...
import pandas as pd
from pipelinesrc.entity.artifact_entity  import DataIngestionArtifact,DataValidationArtifact,DataTransformationArtifact,ModelTrainerArtifact,ModelEvaluatioArtifact
from pipelinesrc.entity.config_entity  import ModelTrainerConfig,DataIngestionConfig,DataTransformationCofig,DataValidationConfig,ModelEvaluationConfig
...
from pipelinesrc.utils.main_utils import load_object,read_yaml_file
...
class ModelEvaluation:
    ...
    def evaluate_model(self) ->EvaluateModelResponse:
        ...
        try:
            ...
            logging.info("Test data loaded and ow transforming it for prediction")
            ...
            logging.info(f"F1_score production model:{trained_model_f1_score}")
            ...
            if best_model is not None:
                ...
                logging.info(f"F1_score-Production Model:{best_model_f1_score},F2_score-New Trained Model:{trained_model_f1_score}")
    ...
    def initiate_model_evaluation(self) ->ModelEvaluatioArtifact:

        try:
            logging.info(f"Intitialized Model Evaluation Component")

            evaluate_model_response=self.evaluate_model()
            s3_model_path=self.model_eval_config.s3_model_key_path

            model_evaluation_artifact=ModelEvaluatioArtifact(
