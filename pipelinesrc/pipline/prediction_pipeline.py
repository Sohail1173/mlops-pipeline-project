import sys
from pipelinesrc.entity.config_entity import VehiclePredictorConfig
...
class VehicleData:
    ...
    def get_vehicle_data_as_dict(self):
        logging.info("Entered the get_vehicle_data_as_dict method")
        try:
            input_data={
                "Gender":[self.Gender],
                "Age":[self.Age],
            ...
            logging.info("Exited get_vehicle_data_as_dict")
            return input_data
        except Exception as e:
            raise MyException(e,sys) from e
